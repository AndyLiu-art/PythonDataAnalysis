    \hypertarget{ux5206ux7ec4ux8ba1ux7b97ux6bcfux4e00ux5217ux7684ux6700ux5c0fux503cux7684ux4e0bux6807}{%
\subsubsection{分组计算每一列的最小值的下标}\label{ux5206ux7ec4ux8ba1ux7b97ux6bcfux4e00ux5217ux7684ux6700ux5c0fux503cux7684ux4e0bux6807}}
...
\PY{n}{grouped}\PY{p}{[}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{C}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{D}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{aggregate}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{idxmin}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
