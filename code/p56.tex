    \hypertarget{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperformanceux4e3aux4f8bux5c06genderux53d8ux91cfux53d8ux4e3acategoryux7c7bux578bux5e76ux6dfbux52a0ux4e00ux4e2aux7c7bux522bunknownux7136ux540eux5220ux9664ux8be5ux7c7bux522b}{%
\subsubsection{以openml中的数据集1StudentPerformance为例，将gender变量变为category类型并添加一个类别''Unknown''，然后删除该类别。}\label{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperformanceux4e3aux4f8bux5c06genderux53d8ux91cfux53d8ux4e3acategoryux7c7bux578bux5e76ux6dfbux52a0ux4e00ux4e2aux7c7bux522bunknownux7136ux540eux5220ux9664ux8be5ux7c7bux522b}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{newvar}\PY{o}{.}\PY{n}{cat}\PY{o}{.}\PY{n}{remove\PYZus{}categories}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Unknown}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{newvar}\PY{o}{.}\PY{n}{cat}\PY{o}{.}\PY{n}{remove\PYZus{}categories}\PY{p}{(}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Unknown}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{female}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
