    \hypertarget{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperformanceux4e3aux4f8bux5c06genderux53d8ux91cfux53d8ux4e3acategoryux7c7bux578bux5e76ux4feeux6539ux7c7bux522bux540dux79f0ux4e3aux7537ux6027ux548cux5973ux6027}{%
\subsubsection{以openml中的数据集1StudentPerformance为例，将gender变量变为category类型并修改类别名称为''男性''和''女性''。}\label{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperformanceux4e3aux4f8bux5c06genderux53d8ux91cfux53d8ux4e3acategoryux7c7bux578bux5e76ux4feeux6539ux7c7bux522bux540dux79f0ux4e3aux7537ux6027ux548cux5973ux6027}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} 查看分类变量的类别名称}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{newvar}\PY{o}{.}\PY{n}{cat}\PY{o}{.}\PY{n}{categories}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} 修改分类变量的类别名称}
\PY{n}{new\PYZus{}categories} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{女性}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{男性}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
\PY{n}{newvar} \PY{o}{=} \PY{n}{newvar}\PY{o}{.}\PY{n}{cat}\PY{o}{.}\PY{n}{rename\PYZus{}categories}\PY{p}{(}\PY{n}{new\PYZus{}categories}\PY{p}{)}
\PY{n}{newvar}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
