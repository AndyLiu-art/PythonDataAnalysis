    \hypertarget{ux5bf9ux6bcfux4e00ux5217ux7684ux6700ux5927ux503cux8fdbux884cux9ad8ux4eaeux663eux793a}{%
\subsubsection{对每一列的最大值进行高亮显示}\label{ux5bf9ux6bcfux4e00ux5217ux7684ux6700ux5927ux503cux8fdbux884cux9ad8ux4eaeux663eux793a}}
...
\begin{Verbatim}[commandchars=\\\{\}]
<pandas.io.formats.style.Styler at 0x145f5ac1e10>
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{df}\PY{o}{.}\PY{n}{style}\PY{o}{.}\PY{n}{apply}\PY{p}{(}
    \PY{n}{highlight\PYZus{}max}\PY{p}{,} \PY{n}{props}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{color:white;background\PYZhy{}color:darkblue}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} 
...
\begin{Verbatim}[commandchars=\\\{\}]
<pandas.io.formats.style.Styler at 0x145ef7b0670>
\end{Verbatim}
\end{tcolorbox}
