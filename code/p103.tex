    \hypertarget{ux5bf9dataframeux6dfbux52a0ux80ccux666fux8272ux5185ux7f6eux51fdux6570}{%
\subsubsection{对dataframe添加背景色（内置函数）}\label{ux5bf9dataframeux6dfbux52a0ux80ccux666fux8272ux5185ux7f6eux51fdux6570}}
...
\begin{Verbatim}[commandchars=\\\{\}]
<pandas.io.formats.style.Styler at 0x21c7ec7da50>
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{df}\PY{o}{.}\PY{n}{style}\PY{o}{.}\PY{n}{background\PYZus{}gradient}\PY{p}{(}\PY{n}{cmap}\PY{o}{=}\PY{n}{cm}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<pandas.io.formats.style.Styler at 0x21c788b0bb0>
\end{Verbatim}
\end{tcolorbox}
