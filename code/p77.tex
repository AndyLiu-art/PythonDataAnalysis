    \hypertarget{ux7ed8ux5236ux4e24ux5217ux6570ux636eux7684ux6563ux70b9ux56fe}{%
\subsubsection{绘制两列数据的散点图}\label{ux7ed8ux5236ux4e24ux5217ux6570ux636eux7684ux6563ux70b9ux56fe}}
...
\PY{p}{)}
\PY{n}{df}\PY{o}{.}\PY{n}{plot}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{x}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{a}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{y}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{b}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{./code/output_p77_1.png}
    \end{center}
    { \hspace*{\fill} \\}
