    \hypertarget{ux5206ux7ec4ux8ba1ux7b97ux5269ux4e0bux7684ux7ec4ux522bux4e4bux95f4ux7684ux534fux65b9ux5dee}{%
\subsubsection{分组计算剩下的组别之间的协方差}\label{ux5206ux7ec4ux8ba1ux7b97ux5269ux4e0bux7684ux7ec4ux522bux4e4bux95f4ux7684ux534fux65b9ux5dee}}
...
\PY{c+c1}{\PYZsh{} 对C D求平均数}
\PY{n}{grouped}\PY{p}{[}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{C}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{D}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{aggregate}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{cov}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
