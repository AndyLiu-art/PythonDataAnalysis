    \hypertarget{ux8ba1ux7b97dataframeux6bcfux4e00ux884cux7684ux5747ux503cux5bf9ux4e8eforux5faaux73afux548capplyux65b9ux6cd5ux6539ux53d8ux5217ux6570}{%
\subsubsection{计算DataFrame每一行的均值，对于for循环和apply方法，改变列数}\label{ux8ba1ux7b97dataframeux6bcfux4e00ux884cux7684ux5747ux503cux5bf9ux4e8eforux5faaux73afux548capplyux65b9ux6cd5ux6539ux53d8ux5217ux6570}}
...
\PY{n}{lst} \PY{o}{=} \PY{p}{[}\PY{p}{]}
\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
    \PY{n}{lst}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{df}\PY{o}{.}\PY{n}{iloc}\PY{p}{[}\PY{n}{i}\PY{p}{,} \PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
