    \hypertarget{ux7ed8ux5236ux591aux5217ux6570ux636eux7684ux76f4ux65b9ux56fe}{%
\subsubsection{绘制多列数据的直方图}\label{ux7ed8ux5236ux591aux5217ux6570ux636eux7684ux76f4ux65b9ux56fe}}
...
\PY{p}{)}
\PY{n}{df}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{kind}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hist}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{alpha}\PY{o}{=}\PY{l+m+mf}{0.4}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{./code/output_p68_1.png}
    \end{center}
    { \hspace*{\fill} \\}
