    \hypertarget{ux7ed8ux5236ux5b89ux5fb7ux9c81ux66f2ux7ebfux591aux5143ux5206ux6790ux4e2dux7684ux4e00ux79cdux56feux5f62}{%
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{andrews\PYZus{}curves}\PY{p}{(}\PY{n}{data}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{class}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{./code/output_p87_1.png}
    \end{center}
    { \hspace*{\fill} \\}
