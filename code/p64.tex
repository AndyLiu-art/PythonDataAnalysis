    \hypertarget{ux7ed8ux5236ux591aux5217ux6570ux636eux7684ux5747ux503cux67f1ux72b6ux56fe}{%
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{./code/output_p64_1.png}
    \end{center}
    { \hspace*{\fill} \\}
