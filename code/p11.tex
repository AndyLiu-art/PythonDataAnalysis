    \hypertarget{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperfromanceux4e3aux4f8bux627eux5230writing-scoreux4e2dux5206ux6570ux5927ux4e8e90ux7684ux6837ux672c}{%
\subsubsection{以openml中的数据集1StudentPerfromance为例，找到writing
score中分数大于90的样本。}\label{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperfromanceux4e3aux4f8bux627eux5230writing-scoreux4e2dux5206ux6570ux5927ux4e8e90ux7684ux6837ux672c}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} 分数大于90的样本}
\PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{writing score}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{\PYZgt{}} \PY{l+m+mi}{90}\PY{p}{]}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
106  female        group D            master\textbackslash{}'s degree      standard
110  female        group D         associate\textbackslash{}'s degree  free/reduced
