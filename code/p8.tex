    \hypertarget{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperfromanceux4e3aux4f8bux6c42math-scoreux4e2dux5206ux6570ux4e3aux96f6ux7684ux6837ux672c}{%
\subsubsection{以openml中的数据集1StudentPerfromance为例，求math
score中分数为零的样本。}\label{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperfromanceux4e3aux4f8bux6c42math-scoreux4e2dux5206ux6570ux4e3aux96f6ux7684ux6837ux672c}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} 数学分数为零的样本}
\PY{n}{data}\PY{p}{[}\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{math score}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{]}
\end{Verbatim}
\end{tcolorbox}
