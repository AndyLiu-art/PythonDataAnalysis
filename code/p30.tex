    \hypertarget{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperformanceux4e3aux4f8bux5c06ux5217genderux53d6ux51faux6765ux8f6cux4e3adataframeux5bf9ux8c61}{%
\subsubsection{以openml中的数据集1StudentPerformance为例，将列gender取出来转为dataframe对象。}\label{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperformanceux4e3aux4f8bux5c06ux5217genderux53d6ux51faux6765ux8f6cux4e3adataframeux5bf9ux8c61}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} Series转Dataframe}
\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gender}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{to\PYZus{}frame}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
