    \hypertarget{ux5206ux7ec4ux8ba1ux7b97ux6bcfux4e00ux5217ux7684ux4e2dux4f4dux6570}{%
\subsubsection{分组计算每一列的中位数}\label{ux5206ux7ec4ux8ba1ux7b97ux6bcfux4e00ux5217ux7684ux4e2dux4f4dux6570}}
...
\PY{n}{grouped}\PY{p}{[}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{C}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{D}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{aggregate}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{median}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
