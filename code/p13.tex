    \hypertarget{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperfromanceux4e3aux4f8bux5bfbux627emath-scoreux4e2dux53eaux51faux73b0ux4e00ux6b21ux7684ux6700ux5927ux6570ux503c}{%
\subsubsection{以openml中的数据集1StudentPerfromance为例，寻找math
score中只出现一次的最大数值。}\label{ux4ee5openmlux4e2dux7684ux6570ux636eux96c61studentperfromanceux4e3aux4f8bux5bfbux627emath-scoreux4e2dux53eaux51faux73b0ux4e00ux6b21ux7684ux6700ux5927ux6570ux503c}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} 寻找唯一值，再从唯一值中求最大值}
\PY{n}{data}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{math score}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{o}{.}\PY{n}{unique}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
